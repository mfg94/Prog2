...
public class PredicateLambda {
	...
	public static void main(String[] args) {
		...
		//Wende contains Prädikat auf Beispiel Strings an
		...
		// Prädikate aus vordefinierten Logischen-Methoden zusammensetzen
		
		// Prüfe, ob der String länger als 10 ist UND den Buchstabe O enthält ODER mit Hello beginnt
